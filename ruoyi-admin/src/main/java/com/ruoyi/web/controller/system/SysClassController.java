...
public class SysClassController extends BaseController {
    ...
    public AjaxResult getClassSubjectList(@RequestBody SysQueryDto sysQueryDto)
    {
//        startPage();
    ...
    public AjaxResult getClassStudentList(@PathVariable(value = "id", required = false) int id)
    {
    ...
    public AjaxResult getClassStudentList(@RequestBody SysQueryDto sysQueryDto)
    {
    ...
    @PreAuthorize("@ss.hasPermi('system:class_subject:delete')")
    @PostMapping("/subject/delete/{class_id}/{id}")
    public AjaxResult deleteClassSubject(@PathVariable(value = "id", required = false) int id,@PathVariable(value = "class_id", required = false) int class_id)
    {
        return toAjax(iSysClassService.deleteClassSubject(class_id,id));
    }
